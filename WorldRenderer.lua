        ...
        for x = startX, endX do
            ...
            if blockType ~= self.blockRegistry.BLOCK_AIR then
                ...
                if quadToUse then
                    ...
                    local scaleX = self.tileSize / self.blockRegistry.tilesetSize
                    local scaleY = self.tileSize / self.blockRegistry.tilesetSize
                    ...
                    if type(blockVariant) == "string" and tonumber(blockVariant) then
                        quadToUse = self.blockRegistry.blockQuads[tonumber(blockVariant)]
                        if quadToUse then
                            ...
                            love.graphics.draw(
                                ...
                                pixelY,
                                0,  -- rotation
                                self.tileSize / self.blockRegistry.tilesetSize,
                                self.tileSize / self.blockRegistry.tilesetSize
                            )
                        else
